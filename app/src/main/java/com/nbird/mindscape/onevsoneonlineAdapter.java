...
public class onevsoneonlineAdapter extends PagerAdapter {
    ...
    public onevsoneonlineAdapter(Context context, List<mainMenuFactsHolder> list){
    ...
    public Object instantiateItem( ViewGroup container, int position) {
        ...
        View view =layoutInflater.inflate(R.layout.onevsone_dialog_layout,container,false);
