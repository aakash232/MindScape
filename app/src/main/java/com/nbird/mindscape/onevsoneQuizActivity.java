...
//1344
        ...
        cardViewSpeaker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(songDetect9){
                    ...
                    songActivity=new songActivity(onevsoneQuizActivity.this);
                    songActivity.startMusic();
       ...
       songStopperAndResumer();
        ...
        fiftyfiftyLL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                musicNav = MediaPlayer.create(onevsoneQuizActivity.this, R.raw.lifelinemusic);
                musicNav.start();
                ...
                if(fiftyfiftynum==0) {
                    ...
                    musicNav1 = MediaPlayer.create(onevsoneQuizActivity.this, R.raw.lifelineused);
                    musicNav1.start();
                ...
                if(num==10) {
                    if (list.size() > 0) {
                        ...
                        nextButton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                final MediaPlayer musicNav1;
                                musicNav1 = MediaPlayer.create(onevsoneQuizActivity.this, R.raw.finalbuttonmusic);
                                musicNav1.start();
                                musicNav1.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                                    @Override
                                    public void onCompletion(MediaPlayer mediaPlayer) {
    ...
    private void checkAnswer(Button selectedOption){
        ...
        if(selectedOption.getText().toString().equals(list.get(position).getCorrectAnswer())){
            //correct
         final MediaPlayer musicNav;
                musicNav = MediaPlayer.create(onevsoneQuizActivity.this, R.raw.correctmusic);
                musicNav.start();
                musicNav.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    @Override
                    public void onCompletion(MediaPlayer mediaPlayer) {
            ...
            //incorrect
          final MediaPlayer musicNav;
                musicNav = MediaPlayer.create(onevsoneQuizActivity.this, R.raw.wrongansfinal);
                musicNav.start();
                musicNav.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    @Override
                    public void onCompletion(MediaPlayer mediaPlayer) {
   ...
   public void dialogBoxManupulation(){
       ...
       myRef.child("battleGround").child("onevsoneOnline").child(opponentUID).child("isComplete").addValueEventListener(listner1);
   }
    @Override
    ...
    public void leaveDialog(){
        AlertDialog.Builder builder=new AlertDialog.Builder(onevsoneQuizActivity.this,R.style.AlertDialogTheme);
        View view =LayoutInflater.from(onevsoneQuizActivity.this).inflate(R.layout.removal_lobby_layout,(ConstraintLayout) findViewById(R.id.layoutDialogContainer));
